...
from ..apis import flask_utils
from ..apis.abstract import AbstractAPI
from ..handlers import AuthErrorHandler
from ..jsonifier import Jsonifier
from ..lifecycle import ConnexionRequest, ConnexionResponse
from ..security import FlaskSecurityHandlerFactory
from ..utils import is_json_mimetype, yamldumper
...
class FlaskApi(AbstractAPI):
    ...
    def get_request(cls, *args, **params):
        ...
        """
        context_dict = {}
        # TODO[fdm]: check why this was here
